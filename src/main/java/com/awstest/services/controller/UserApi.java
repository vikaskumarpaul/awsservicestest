...
import com.awstest.services.model.CreateUserRequest;
import com.awstest.services.model.Userdetails;
			...
			for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
				if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
					ApiUtil.setExampleResponse(request, "application/json",
							"{  \"Role\" : [ null, null ],  \"Type\" : [ null, null ],  \"customerUUID\" : [ null, null ],  \"ContactEmail\" : [ null, null ],  \"ContactNumber\" : [ null, null ],  \"id\" : 0,  \"ContactName\" : [ null, null ]}");
					break;
				}
			}
		});
